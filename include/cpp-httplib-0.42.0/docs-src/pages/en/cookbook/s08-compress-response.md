...
When the client accepts multiple encodings, cpp-httplib picks in this order (among those enabled at build time): Brotli to Zstd to gzip. Your code doesn't need to care — you always get the most efficient option available.
